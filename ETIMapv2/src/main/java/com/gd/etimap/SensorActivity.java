...
/**
 * Created by Marcin on 23.11.2017.
 */
...
public class SensorActivity extends Activity implements SensorEventListener{
    ...
    ImageTransformationHelper imageTransformationHelper = new ImageTransformationHelper();
    TileView tileView;
    ListOfAllObjects listOfAllObjects;

    public SensorActivity(ListOfAllObjects listOfAllObjects, TileView tileView, Context context) {
